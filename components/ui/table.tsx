...
function TableBody({ className, ...props }: React.ComponentProps<"tbody">) {
  return (
    <tbody
      ...
      className={cn(
        "[&_tr:last-child]:border-0 [&_tr:nth-child(even)]:bg-muted/30 [&_tr:nth-child(even)]:dark:bg-muted/20",
        className
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-all duration-200 cursor-pointer",
        className
      )}
      {...props}
    />
